...
enum fotahal_return_e {
	...
	FOTAHAL_RETURN_ERROR    = 1,
	FOTAHAL_RETURN_OPENFAIL     =2,
	FOTAHAL_RETURN_WRITEFAIL    =3,
	FOTAHAL_RETURN_ERASEFAIL    =4,
	FOTAHAL_RETURN_CLOSEFAIL    =5,
	FOTAHAL_RETURN_CHECKSUMFAIL=6,
	FOTAHAL_RETURN_WRONGMAGIC=7,
	FOTAHAL_RETURN_WRONGBIN=8,
	FOTAHAL_RETURN_WRONGSIZE=9,
	FOTAHAL_RETURN_WRONGHANDLE=10,
	FOTAHAL_RETURN_PART_NOTSET=11,
